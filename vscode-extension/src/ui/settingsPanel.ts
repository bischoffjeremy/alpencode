...
export class SettingsPanel { 
    ...
    private _backend: PythonBackendManager;

    private constructor(panel: vscode.WebviewPanel, extensionPath: string, backend: PythonBackendManager) {
        this._panel = panel;
    ...
    public static createOrShow(extensionPath: string, backend: PythonBackendManager) {
